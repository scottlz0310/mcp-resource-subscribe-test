...
Use this directory to record client compatibility findings.
...
- Keep server log excerpts short and focused on MCP message evidence.
- Prefer exact client version numbers and dates for reproducibility.
- For E2E logs against external servers, include the server URL, auth method, and client version.
